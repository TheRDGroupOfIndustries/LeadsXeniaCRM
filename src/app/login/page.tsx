      ...
      <div className="w-full max-w-md">
        <div className="bg-[#12123d]/80 backdrop-blur-xl rounded-2xl shadow-2xl border border-[#2a2a6e]/50 p-8">
          ...
          <div className="flex justify-center mb-6">
            <img src="/logo.png" alt="Leads Xenia" className="h-16 w-auto" />
          </div>
          ...
          <div className="relative mb-6">
            <div className="absolute inset-0 flex items-center">
              <div className="w-full border-t border-[#2a2a6e]"></div>
            </div>
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-[#12123d]/80 text-slate-300">or continue with email</span>
            </div>
          </div>
            ...
            {!isLogin && (
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-[#1a1a4e]/50 border border-[#2a2a6e] rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                />
              </div>
            )}
